...
public class OrderServiceImpl extends JpaCrudService<Order, Long> implements OrderService {
    ...
    public OrderServiceImpl(JpaRepository<Order, Long> repository, JpaSpecificationExecutor<Order> specificationExecutor, EntityManager persistenceContext, TransactionTemplate transactionTemplate, Validator validator) {
