...
public class UserServiceImpl extends JpaCrudService<User, Long> implements UserService {
    ...
    public UserServiceImpl(JpaRepository<User, Long> repository, JpaSpecificationExecutor<User> specificationExecutor, EntityManager persistenceContext, TransactionTemplate transactionTemplate, Validator validator) {
