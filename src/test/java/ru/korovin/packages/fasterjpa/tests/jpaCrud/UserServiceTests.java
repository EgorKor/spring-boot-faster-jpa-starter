...
import ru.korovin.packages.fasterjpa.testProject.repository.UserRepository;
...
public class UserServiceTests {
    ...
    public void testFindByIdWithJoin() {
        stats.setStatisticsEnabled(true);
        var res = userService.getById(1L, Joins.of("orders"));
        stats.setStatisticsEnabled(false);
        assertEquals(1, stats.getPrepareStatementCount());
    ...
    public void testFilterWithLocalDateTime() {
        userService.getList(Filters.greaterThan("createdAt", "2025-09-28"));
        userService.getList(Filters.greaterThan("updatedAt", LocalDateTime.now()));
    }
