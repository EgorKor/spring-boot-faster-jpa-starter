...
import static ru.korovin.packages.fasterjpa.queryparam.factories.Paginations.unpaged;
...
public class PaginationTest {
    ...
    void testDefaultConstructor() {
        ...
        assertEquals(Paginations.DEFAULT_PAGE_SIZE, pagination.getSize());
        assertEquals(Paginations.DEFAULT_PAGE, pagination.getPage());
    }
    ...
    void testIsUnpaged_whenAllContentSize() {
        Pagination pagination = Paginations.unpaged();
    ...
    void testUnpaged() {
        Pagination pagination = Paginations.unpaged();
        assertEquals(Paginations.ALL_CONTENT_SIZE, pagination.getSize());
    }

    @Test
    void testOf() {
        Pagination pagination = Paginations.of(2, 20);
        assertEquals(20, pagination.getSize());
        assertEquals(2, pagination.getPage());
    }
