...
public class SearchRequest {
    ...
    private FilterCondition parseFilter(String param, String value) {
        ...
        return new FilterCondition(param, filterOperation, pureValue);
    }
    ...
    public static class SearchRequestBuilder<F extends Filter<?>, S extends Sorting> {
        ...
        private Map<String, BiFunction<String, String, Filter<?>>> customParsers;

        SearchRequestBuilder() {
            customParsers = new HashMap<>();
        }

        public SearchRequestBuilder params(@NonNull MultiValueMap<String, String> params) {
            this.params = params;
            return this;
        }

        public SearchRequestBuilder filterClass(@NonNull Class<F> filterClass) {
            this.filterClass = filterClass;
            return this;
        }

        public SearchRequestBuilder sortingClass(@NonNull Class<S> sortingClass) {
            this.sortingClass = sortingClass;
            return this;
        }

        public SearchRequestBuilder customParser(@NonNull String queryParam, @NonNull BiFunction<String, String, Filter<?>> customParser) {
