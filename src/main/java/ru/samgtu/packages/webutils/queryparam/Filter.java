...
import ru.samgtu.packages.webutils.queryparam.filterInternal.*;
import ru.samgtu.packages.webutils.queryparam.utils.FieldTypeUtils;
...
import static ru.samgtu.packages.webutils.annotations.FieldParamMapping.NO_MAPPING;
import static ru.samgtu.packages.webutils.queryparam.filterInternal.FilterOperation.IS;
    ...
    private Predicate parsePredicate(FilterCondition filter,
        ...
        try {
            ...
            return switch (operation) {
                ...
                case NOT_IN -> cb.not(parseInPredicate(cb, selection, reflectionField, (List<Object>) value, function, field));
            };
        } catch (Exception e) {
